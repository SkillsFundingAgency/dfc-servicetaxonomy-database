...
ENV NEO4J_dbms_default__advertised__address=dev.servicetaxonomy.nationalcareersservice.org.uk
...
ENV NEO4J_dbms_connector_bolt_advertised__address=dev.servicetaxonomy.nationalcareersservice.org.uk:7687
ENV NEO4J_dbms_connector_http_enabled=true
ENV NEO4J_dbms_connector_http_listen__address=0.0.0.0:7474
ENV NEO4J_dbms_connector_http_advertised__address=dev.servicetaxonomy.nationalcareersservice.org.uk:7474
ENV NEO4J_dbms_connector_https_enabled=true
ENV NEO4J_dbms_connector_https_listen__address=0.0.0.0:7473
ENV NEO4J_dbms_connector_https_advertised__address=dev.servicetaxonomy.nationalcareersservice.org.uk:7473
