...
```
docker run -p7474:7474 -p7687:7687 -e NEO4J_dbms_memory_pagecache_size=500M -e NEO4J_ncs_occupation__synonyms__file__url=https://dfc-dev-stax-editor-as.azurewebsites.net/graphsync/synonyms/occupation/synonyms.txt -e NEO4J_ncs_skill__synonyms__file__url=https://dfc-dev-stax-editor-as.azurewebsites.net/graphsync/synonyms/skill/synonyms.txt -v $HOME\neo4j\import:/var/lib/neo4j/import ncs.servicetaxonomy.escodb
```
